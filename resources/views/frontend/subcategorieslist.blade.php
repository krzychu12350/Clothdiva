        ...
        <div class = "women_products position-absolute bg-white col-xl-6 text-center" style = "display:none; right: 25%; margin: auto;">    
         ...
         <div class = "men_products position-absolute bg-white col-xl-6 text-center" style = "display:none; right: 25%; margin: auto;">
                <div class="container">
                    ...
                    <div class="col-3 mx-auto">     
                    <ul class = "submenu-submenu list-unstyled" style = "text-align:center">
                    <a style = "color:black" href="{{ route('showProducts',['type'=> 'Men','subcategory'=> $sub_category_man->name_of_subcategory]) }}"><img src='images\subcategories\men\men<?php echo $i; ?>.jpg'></a>
         ...
         <div class = "girls_products position-absolute bg-white col-xl-6 text-center" style = "display:none; right: 25%; margin: auto;">
            <div class="container">
                    ...
                    <div class="col-3 mx-auto">  
                    <ul class = "submenu-submenu list-unstyled" style = "text-align:center">
                    <a style = "color:black" href="{{ route('showProducts',['type'=> 'Girls','subcategory'=> $sub_category_girl->name_of_subcategory]) }}"><img src='images\subcategories\girls\girl<?php echo $i; ?>.jpg'></a>
         ...
         <div class = "boys_products position-absolute bg-white col-xl-6 text-center" style = "display:none; right: 25%; margin: auto;">
            <div class="container">
                    ...
                    <?php $i = 1 ?>
                     ...
                     <div class="col-3 mx-auto">    
                     <ul class = "submenu-submenu list-unstyled" style = "text-align:center">
                     <a style = "color:black" href="{{ route('showProducts',['type'=> 'Boys','subcategory'=> $sub_category_boy->name_of_subcategory]) }}"><img src='images\subcategories\boys\boy<?php echo $i; ?>.jpg'></a>
